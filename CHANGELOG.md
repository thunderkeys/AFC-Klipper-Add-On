...
## [2026-04-12]
### Fixed
- LED color tuples in config are now validated at startup, preventing an internal error during tool change when a typo (e.g. period instead of comma) is present
